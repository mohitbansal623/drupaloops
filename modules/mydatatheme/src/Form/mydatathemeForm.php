...
namespace Drupal\mydatatheme\Form;
...
/**
 * Class mydatathemeForm.
 *
 * @package Drupal\mydatatheme\Form
 */
class mydatathemeForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $conn = Database::getConnection();
     $record = array();
    if (isset($_GET['num'])) {
        $query = $conn->select('mydatatheme', 'm')
  ...
  public function checkRadioSelected(array $form, FormStateInterface $form_state) {
     ...
     \Drupal::logger('mydatatheme')->notice('message');

     // $values = $form_state['values']['select_radio'];
     // \Drupal::logger('mydatatheme')->notice($values);
    ...
    // \Drupal::logger('mydatatheme')->notice($email);
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    if (isset($_GET['num'])) {
          ...
          $query->update('mydatatheme')
              ->fields($field)
              ->condition('id', $_GET['num'])
              ->execute();
          drupal_set_message("succesfully updated");
          $form_state->setRedirect('mydatatheme.display_table_controller_display');
       ...
       else
       {
           ...
           $query = \Drupal::database();
           $query ->insert('mydatatheme')
               ->fields($field)
               ->execute();
           drupal_set_message("succesfully saved");

           $response = new RedirectResponse("/mydatatheme/hello/table");
           $response->send();
       }
     }
